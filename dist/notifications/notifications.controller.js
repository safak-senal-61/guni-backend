...
let NotificationsController = class NotificationsController {
    ...
    async getUserNotifications(req, query) {
        return this.notificationsService.getUserNotifications(req.user.userId, query.page, query.limit);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, notifications_dto_1.GetNotificationsDto]),
    __metadata("design:returntype", Promise)
